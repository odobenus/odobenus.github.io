...
поиска обнаружил DBCP от apache и [статью на винграде](http://forum.vingrad.ru/sources/topic-157958.html)
...
Очень печально, что в библиотеках org.apache.tomcat.dbcp.dbcp и
org.apache.commons.dbcp нет такого метода, как boolean
validConnection(Connection c)...

меня интересует вопрос - насколько надежно тот способ, котором вы сами
пользуетесь?  потому что в этой технологии тестирование практически
очень затруднительное///
